...

{
    ...
    public $sortable = ['name','last_name','national_id','phone_number', 'email', 'created_at', 'updated_at'];
    ...
    protected $fillable = ['name', 'email','last_name','phone_number','national_id', 'password', 'active', 'confirmation_code', 'confirmed','created_by','pin'];
