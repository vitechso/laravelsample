...
if(!function_exists('websitelogo1'))

{
    ...
    function websitelogo1()

    {

        $settings = DB::table('website_settings')->select(['logo1'])->get();
...
function imagefolderpath($imagename='')

{
    ...
    return URL::to('/').'/assets/images/'.$imagename;
...

{
...

    {
        ...
        $settings = DB::table('website_settings')->select(['appname'])->get();
...
if(!function_exists('common_tbcolval_function'))

{
    ...
    function common_tbcolval_function($tbname,$whereid,$wherevalue)

    {

        $settings = DB::table($tbname)->select('cat_name')->whereIn($whereid, $wherevalue)->get();
...

{
...

    {
        ...
        $settings = DB::table('categories')->get();
