...
@include('admin.include.flash-messages')
											    ...
											    <tbody>
											    	...
											    	@php $k+=1; @endphp
											      	<tr>
												        ...
												        <td class="text-center status">@if($user->active==1) Active @else Inactive @endif</td>
												        <td class="text-center action">
												        	<a  href="#edit_admin" data-toggle="modal" class="file-block" onclick="editusers(`{{$user->name}}`,`{{$user->phone_number}}`,`{{$user->email}}`,`{{$user->id}}`,`{{$user->active}}`)"><i class="fas fa-pencil-alt"></i></a>
	    ...
	    <div class="modal-dialog popup-center">
	    	<div class="modal-content bg-theme">
		        ...
		        <div class="modal-header add-admin-heading-block">
		        	<h3 class="modal-title"><i class="fas fa-user-plus"></i>Add <span>Accounts</span></h3>
		          	<button type="button" class="close close-btn" data-dismiss="modal">×</button>
		        </div>
	        
		        <!-- Modal body -->
		        <div class="modal-body">
        			{{ Form::open(['route'=>['admin.users.add'],'method' => 'post','class'=>'user-add-form form-horizontal form-label-left','style'=>'width:100%;']) }}
		        	<div class="row">
		        		...
		        		<div class="col-lg-6 col-md-6 col-12">
		        			<div class="add-admin-block">
								...
								<div class="form-group lock">
								    ...
								    <input type="password" class="form-control custom-color place-adjuct-center @if($errors->has('password')) parsley-error @endif" placeholder="{{ __('views.admin.users.edit.password') }}" id="password" name="password" value="{{old('password')}}">
								...
								<div class="form-group lock">
									<i class="fas fa-unlock-alt"></i>
								    <input type="password" class="form-control custom-color place-adjuct-center @if($errors->has('confirmed')) parsley-error @endif" placeholder="{{ __('views.admin.users.edit.confirmed') }}" id="password" name="confirmed" value="{{old('confirmed')}}">
	...
	<div class="modal fade" id="edit_admin">
	    <div class="modal-dialog popup-center">
	    	<div class="modal-content bg-theme">
		        ...
		        <!-- Modal Header -->
		        <div class="modal-header add-admin-heading-block">
		        	<h3 class="modal-title"><i class="fas fa-user-plus"></i>Edit <span>Accouts</span></h3>
		          	<button type="button" class="close close-btn" data-dismiss="modal">×</button>
		        </div>
		        	...
		        	<div class="row">
		        		...
		        		<div class="col-lg-12 col-md-12 col-12">
		        			<div class="add-admin-block">
								...
								<div class="select form-group">
									<select name="status" id="editslct" class="form-control custom-color hight-adjust popup-select-block" required>
								    	<option selected disabled value="">Status</option>
								    	<option value="1">Active</option>
								    	<option value="0">Inactive</option>
								  </select>
	...
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
  	...
  	<script>
		...
		function editusers(name,phone_number,email,id,status) {
			console.log(status);
			$('#edit_admin input[name="name"]').val(name);
			$('#edit_admin input[name="email"]').val(email);
			$('#edit_admin input[name="phone_number"]').val(phone_number);
			$('#edit_admin input[name="user_editid"]').val(id);
			$('#edit_admin #editslct').val(status);
		}
	</script>
</body>
</html>
