					...
					<div class="col-lg-12 col-md-12 col-12">
						<div class="pacts-info">
							...
							<ul class="nav nav-tabs custom-nav-tabs ">
							    <li class="nav-item">
							      <a class="nav-link active" data-toggle="tab" href="#home">Pacts</a>
							    </li>
							    <li class="nav-item">
							      <a class="nav-link" href="{{route('company.pact-template')}}">Templates</a>
							    </li>
						  	</ul>
											...
											<table class="table my-table-striped table-responsive inline-table custom-table">
											    ...
											    <tbody>
											    	...
											    	@php $k+=1; @endphp
												     ...
												     <!--    <td class="text-center">{{$pact_temp_val->temp_section}}</td> -->
												        <td class="text-center">{{count(explode(",",$pact_temp_val->section_title))}}</td>
												        <td class="text-center">

												        	<!-- {{count(json_decode($pact_temp_val->clause_body,true))}} -->
                          

                                                          <?php
                                                             $clause_body=[];
                                                             $clause_body=json_decode($pact_temp_val->clause_body,true);
                                                             $clause_body_count=0;
                                                             if(!empty($clause_body))
                                                             {
                                                           foreach ($clause_body as $key => $value) {
                                                             	$clause_body_count+=count($value);//echo "<br>";
                                                             }
                                                             echo $clause_body_count;
                                                         }
                                                          ?>
												        ...
												        <td class="text-center action">
												        	<a  href="{{route('company.pactedit',[$pact_temp_val->id])}}"><i class="fas fa-pencil-alt"></i></a>
												        	<a href="{{ route('company.pact_destroy', [$pact_temp_val->id]) }}"><i class="far fa-window-close"></i></a>
												        </td>
											      	</tr>
