            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <!-- Nav tabs -->
                            <ul class="nav custom-nav-tabs ">
                                <li class="nav-item">
                                  <a class="nav-link active" href="#home">Add 
                                  @if(Request::path()=='admin/users/create-admin') Admin @else Signee @endif</a>
                                </li>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('name')) parsley-error @endif" name="name" value="{{ old('name') }}" required>
                        @if($errors->has('name'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="email" type="email" class="form-control col-md-7 col-xs-12 @if($errors->has('email')) parsley-error @endif" name="email" value="" required>
                        @if($errors->has('email'))
                            <ul class="parsley-errors-list filled">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="password" type="text" class="form-control col-md-7 col-xs-12 @if($errors->has('phone_number')) parsley-error @endif" name="phone_number" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">
                        {{ __('views.admin.users.edit.password') }}<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="password" type="password" class="form-control col-md-7 col-xs-12 @if($errors->has('password')) parsley-error @endif" name="password">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="confirmed">
                        {{ __('views.admin.users.edit.confirmed') }}<span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="confirmed" type="password" class="form-control col-md-7 col-xs-12 @if($errors->has('confirmed')) parsley-error @endif" name="confirmed">
