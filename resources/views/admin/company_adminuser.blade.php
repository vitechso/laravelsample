					...
					<div class="col-lg-12 col-md-12 col-12">
						<div class="pacts-info">
							...
							<ul class="nav nav-tabs custom-nav-tabs ">
							    <li class="nav-item">
							      <a class="nav-link active" data-toggle="tab" href="#home">SIGNEES Users</a>
							    </li>
							    <!-- <li class="nav-item">
							    	...
							    	<div class="row">
							    		<div class="col-lg-12 col-md-12 col-12 pad-0">
							    			<div class="file-nav-block">
							    				...
							    				<a  href="#add_signees" id="plusadmin" data-toggle="modal" class="file-block plusmodel">
											    ...
											    <tbody>
											    	...
											    	@if($user->roles[0]->id==3)
											      	<tr>
												        ...
												        <td class="text-center view-detail"><a href="#" class="pact_assignments" data-toggle="modal" data-target="#pact_assignments">Views</a></td>
												        ...
												        <td class="text-center action">
												        	...
												        	<a href="{{ route('companyadmin.destroy', [$user->id]) }}"><i class="far fa-window-close"></i></a>
												        </td>
											      	</tr>
											      	@endif
											      	@endforeach
	    ...
	    <div class="modal-dialog popup-center">
	    	<div class="modal-content bg-theme">
		        ...
		        <div class="modal-body">
        			{{ Form::open(['route'=>['companyadmin.add'],'method' => 'post','class'=>'user-add-form form-horizontal form-label-left']) }}
		        	<div class="row">
		        		...
		        		<div class="col-lg-6 col-md-6 col-12 other-field-section">
		        			<div class="add-admin-block">
								...
								<div class="form-group lock">
								    ...
								    <input type="email" class="form-control custom-color place-adjuct-center @if($errors->has('email')) parsley-error @endif" placeholder="{{ __('views.admin.users.edit.adminaccountemail') }}" id="email" value="{{old('email')}}" name="email" required>
								    @if($errors->has('email'))
			                            <ul class="parsley-errors-list filled">
								...
								<div class="form-group lock">
								    ...
								    <input type="text" class="form-control custom-color place-adjuct-center @if($errors->has('phone_number')) parsley-error @endif" placeholder="{{ __('views.admin.users.edit.phone') }}" id="phone" name="phone_number" value="{{old('phone_number')}}" oninput="this.value=this.value.replace(/[^0-9]/g,'');" required>
		        		...
		        		<div class="col-lg-6 col-md-6 col-12 password-section">
		        			<div class="add-admin-block">
								...
								<div class="select form-group">
									<select name="status" id="slct" class="form-control custom-color hight-adjust" required>
	...
	<div class="modal fade" id="edit_signees">
	    <div class="modal-dialog popup-center">
	    	<div class="modal-content bg-theme">
		        ...
		        <!-- Modal body -->
		        <div class="modal-body">
        			{{ Form::open(['route'=>['companyadmin.edit'],'method' => 'put','class'=>'user-add-form form-horizontal form-label-left']) }}
		        	<div class="row">
		        		...
		        		<div class="col-lg-12 col-md-12 col-12">
		        			<div class="add-admin-block">
								...
								<div class="select form-group">
									...
									<select name="status" id="slct-edit" class="form-control custom-color hight-adjust" required>
								    	<option value=""></option>
								    	<option value="1">Active</option>
								    	<option value="0">Inactive</option>
								  </select>
								...
								<div class="form-group lock">
								    <i class="fas fa-unlock-alt"></i>
								    <input type="text" maxlength="6" class="form-control custom-color place-adjuct-center" placeholder="Pin No." id="pin" name="pin">
	    ...
	    <div class="modal-dialog popup-center">
	    	<div class="modal-content bg-theme">
		        ...
		        <div class="modal-body">
        			...
        			{{ Form::open(['route'=>['companyadmin.assign_userpact'],'method' => 'post','class'=>'user-add-form form-horizontal form-label-left']) }}
